# Noto Serif Tamil (embedded PDF font)

`NotoSerifTamil-Regular.js` and `NotoSerifTamil-Bold.js` each export a base64
string of a static TrueType instance of **Noto Serif Tamil**, used to embed
...
1. Source: the variable font published at
   `https://raw.githubusercontent.com/google/fonts/main/ofl/notoseriftamil/NotoSerifTamil%5Bwdth,wght%5D.ttf`
   (Noto Project, licensed under the SIL Open Font License 1.1 — see
   `OFL-LICENSE.txt`).
2. Pin a static instance per weight with fontTools:
   `fonttools varLib.instancer -o NotoSerifTamil-Regular.ttf NotoSerifTamil[wdth,wght].ttf wght=400 wdth=100`
